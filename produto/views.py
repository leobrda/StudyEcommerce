    ...
    def get(self, *args, **kwargs):
        ...
        if variacao_id in carrinho:
            ...
            if variacao_estoque < quantidade_carrinho:
                messages.warning(
                    self.request,
                    f'Estoque insuficiente para {quantidade_carrinho}x no produto "{produto_nome}". Adicionamos'
...
class ResumoDaCompra(View):
    def get(self, *args, **kwargs):
        ...
        return render(self.request, 'produto/resumodacompra.html', context=context)
